...
function getReportStyles(layout,forPrint=false){
  return '@page{size:'+layout.pageSize+';margin:14mm}'+
    ...
    '.page{box-sizing:border-box;width:'+layout.pageWidth+';min-height:'+layout.pageMinHeight+';padding:14mm;page-break-after:always;display:flex;flex-direction:column;gap:8mm}'+
    ...
    (forPrint?'@media print{html,body{width:'+layout.pageWidth+';min-height:'+layout.pageMinHeight+'}.page{padding:0}}':'');
}
